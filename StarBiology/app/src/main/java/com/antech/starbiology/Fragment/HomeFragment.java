...
import com.antech.starbiology.Activity.SavedQuiz;
...
import com.antech.starbiology.Adapter.QuestionAdapter;
import com.antech.starbiology.ModelClass.QuestionModelClass;
import com.antech.starbiology.Question.QuestionActivity;
...
public class HomeFragment extends Fragment {
                        ...
                        if (querySnapshot != null) {
                            for (DocumentSnapshot document : querySnapshot.getDocuments()) {
                                ...
                                if (imageUrl != null && !imageUrl.isEmpty()) {
                                    ...
                                    // Log or handle the missing imageUrl case (optional)
                                    Log.e("Firestore", "Invalid imageUrl found in Firestore");
                                }
                            }
                            // Set the images to the slider if any valid images are found
    ...
    private void setupToolbar(View view) {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") Drawable customIcon = requireContext().getDrawable(R.drawable.baseline_align_horizontal_left_24); // Replace with your drawable
    ...
    private void handleNavigationItemSelected(int itemId) {
        if (itemId == R.id.nav_quiz) {
            startActivity(new Intent(getActivity(), SavedQuiz.class));
        }
    ...
    private void contactUs() {
        ...
        emailIntent.setData(Uri.parse("assist.starbiology@gmail.com"));
