...
public class FrontendVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frontend_video, container, false);

        progressBar = view.findViewById(R.id.videoLoadFrontendProgressBar);
        progressBar.getIndeterminateDrawable().setColorFilter(
                ContextCompat.getColor(getActivity(), R.color.app_color),
                android.graphics.PorterDuff.Mode.SRC_IN);
        recyclerView = view.findViewById(R.id.frontendVideoRCV);
    ...
    private void fetchZoologyVideos() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("BOTANYVIDEOS");
