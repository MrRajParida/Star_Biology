...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.QuestionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull QuestionViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> openNoteViewActivity(question.getqUrl(), question.getqTopic(), question.getqSubject()));
    ...
    private void openNoteViewActivity(String pdfUrl, String pdfTitle, String pdfSub) {
        Intent intent = new Intent(context, NoteViewActivity.class);
        intent.putExtra("pdfUrl", pdfUrl);
        intent.putExtra("pdfTopic", pdfTitle);
