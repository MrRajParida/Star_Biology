package com.antech.starbiologyedu.Note;
...
import com.starproduction.starbiology.Adapter.NoteAdapter;
...
public class NoteZoologyFragment extends Fragment {
    ...
    private void fetchDataFromFireStore() {
        CollectionReference zoologyPdfRef = firestore.collection("ZOOLOGYNOTES");
