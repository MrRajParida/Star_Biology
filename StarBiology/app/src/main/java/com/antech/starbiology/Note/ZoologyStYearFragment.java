...
public class ZoologyStYearFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_zoology_st_year, container, false);
    ...
    private void fetchDataFromFireStore() {
        CollectionReference zoologyPdfRef = firestore.collection("ZOOLOGYSTYEARNOTES");
