...
public class BotanyNdYearFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_botany_nd_year, container, false);
    ...
    private void fetchDataFromFireStore() {
        CollectionReference botanyPdfRef = firestore.collection("BOTANYNDYEARNOTES");
